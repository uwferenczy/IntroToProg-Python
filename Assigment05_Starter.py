...
# DFerenczy,5.10.2021,Added code to complete assignment 5 - Maintained date format of block
# DFerenczy,5.10.2021,Updated strMenu variable to contain Menu text
...
while (True):
    ...
    # Step 5 - Remove a new item from the list/Table
        ...
        for row in lstTable:
            ...
            if strRemoveTask.lower() == strTask.lower():
